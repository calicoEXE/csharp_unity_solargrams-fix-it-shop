...
public class QuestUIList_backup_18_11_2023 : MonoBehaviour
{
    ...
    public GameObject narrNPC;
    public GameObject narrItem;
    ...
    private void Update()
    {
        ...
        if (refToGM.oSCall == GameManager.overallState.storyPlay)
        {
            ...
            {
                //ALL NARRAZTIVEMANAGER NPC AND ADD IT TO goNPC
                ////SKY LOOK BELOW
                //////////////////////////////////////////////////narrNPC = get the narrative npc from the narrative manager into here using the variable before the equal sign
                ///narrItem
            ...
            else if (repairState == repairStates.choose)
            {
                ...
                //narrItem = //get from narrative manager
                //narrNPC = //get from narrative manager
                //alertDescText.text =
                //alertText.text =
                


                //set active here already
                alertDiffText.text = "EMERGENCY";
                bool alertRequest = false;
                if(refToAlertGO.GetComponent<ClickInteractionScript>().acceptedRequest == true)
                {
                    Debug.Log("alerted");
                    alertRequest = true;
